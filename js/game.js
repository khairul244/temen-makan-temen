...
Game.Load.prototype = {
  preload: function() {
    ...
    game.load.image('player', 'images/padli1.png');
...
Game.Menu.prototype = {
  create: function() {
    game.stage.backgroundColor = '#e91e63';
    this.cursor = this.game.input.keyboard.createCursorKeys();
    var label = game.add.text(w / 2, h / 2 - 100, 'Teman \n Makan \nTeman', {
      font: '60px Arial',
      fill: '#2c2c2c',
      align: 'center'
    });
    ...
    var label = game.add.text(w / 2, h - 150, 'Tekan Atas Untuk Mulai \n\n TI_B Fakultas Teknik' , {
      font: '25px Arial',
      fill: '#2c2c2c'
    });
    label.anchor.setTo(0.5, 0.5);
...
Game.Play.prototype = {
  create: function() {
    game.stage.backgroundColor = '#673ab7';
...
Game.End.prototype = {
  create: function() {
    game.stage.backgroundColor = '#cddc39';
    if (score > best_score)
      best_score = score;
    this.cursor = this.game.input.keyboard.createCursorKeys();
    var label = game.add.text(w / 2, h / 2 - 100, 'Pelot Ente', {
      font: '60px Arial',
      fill: '#fff',
      align: 'center'
    });
    ...
    var label3 = game.add.text(w / 2, h - 120, 'Tekan Tombol Atas Untuk Mulai', {
      font: '25px Arial',
      fill: '#fff',
      align: 'center'
    });
